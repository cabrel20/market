  ...
  return (
    <React.Fragment>
     ...
     <form className="bg-slate-100 w-2/5 rounded-md h-96 flex flex-col items-center gap-4 ">
           <h1 className='text-4xl text-gray-600 text-center pb-6 pt-4'>Register</h1>
           <input type="text" placeholder='enter your name'className='h-12 pl-2 bg-white text-gray-600 w-1/2 outline-2 outline-blue-600 rounded-md'/>
        ...
        <button className='mt-6 px-8 py-1 rounded-md bg-blue-500 text-white'>s'inscrire</button>    
           
            <div className='flex justify-center w-full gap-2 pb-6'>
            <p> Deja inscrit ?</p>
            <Link className='text-blue-500 underline' to="/login">Connecte-toi</Link>
            </div>
